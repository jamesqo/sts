...
In the following theorems, variables with the letters $f$, $g$, or $h$ denote arbitrary, non-decreasing functions with positive outputs for sufficiently large $n$.
...
\begin{corollary}
	Both sides of a $\FluteLess$ or $\FluteLeq$ relation may be added, multiplied, or divided by the same function.
\end{corollary}