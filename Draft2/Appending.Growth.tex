...
It takes $O(n)$ time to append $n$ items to a growth array. To see this, ...

% For the reasons given in the dynamic array section, I wish to find $\FuncWritesGrowthArray(n)$ (denoted by $\FuncWrites(n)$ in this section) in order to compare the speeds of dynamic and growth arrays.
