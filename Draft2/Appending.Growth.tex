...
Now, consider the ratio $\lim_{n \to \infty} \left( \FuncSpaceTail(\VarUseful) / \VarCapacitySeq_\VarUseful \right) = O(\log n) / O(n) = O({\log n} / {n}) = 0$. Because it is $0$, from \ref{thm:RemovesLowerOrderTerms} we may conclude
\begin{align*}
