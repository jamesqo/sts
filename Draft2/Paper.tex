...
\newcommand{\VarBuffer}{\textit{buf}}
\newcommand{\VarIndex}{\textit{i}}
\newcommand{\VarNewBuffer}{\textit{new buf}}
\newcommand{\VarNewHeadCapacity}{\textit{new hcap}}
