...
\begin{document}
	...
	so the goal is now to find a formula for $\nwritesresizefn(i)$. First note that all of the writing in [resize] comes from the call to [add] on a dynamic array. Let the initial capacity of the dynamic array be $\initcapacity$ and its growth factor be $\growthfactor$. We showed before that
